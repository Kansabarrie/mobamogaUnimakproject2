    ...
    return (
        <main className="flex min-h-screen flex-col p-0">
            ...
            <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
                <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/3 md:px-20">
                    <p className="text-xl text-gray-800 md:text-3xl md:leading-normal">
                        <strong>Welcome to Acme.</strong> This is <strong><span className="text-blue-900">MOBA</span> <span className="text-red-900">MOGA</span> UNIMAK CHAPTER</strong>{' '}
            ...
            <section className="mt-10 px-6 md:px-20">
                <h2 className="text-2xl font-bold text-gray-800 md:text-3xl">About MOBA MOGA UNIMAK Chapter</h2>
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-3">
                    <div className="flex flex-col items-center text-justify">
                        <Image src="/images/mssb2.jpg" alt="Event 1" width={300} height={200}
                    ...
                    <div className="flex flex-col items-center text-justify">
                        <Image src="/images/mssg1.jpg" alt="Event 2" width={300} height={200}
                               className="rounded-lg shadow-md"/>
                        <p className="mt-2 text-gray-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    ...
                    <div className="flex flex-col items-center text-justify">
                        <Image src="/images/mobamoga1.jpg" alt="Event 3" width={300} height={200}
                               className="rounded-lg shadow-md"/>
                        <p className="mt-2 text-gray-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
